...
(function(a){
	    a.fn.main_slideshow=function(p){
        var p=p||{};
        ...
        s_s_n(F.find(".main_slideshow_nav"),x,w,z,A,B,C);
        ...
        F.find(".main_slideshow_nav").children("li").hover(
            function(){
                stop($(this));
            },
            function(){
        ...
        function play(){
            if(n=="enable"){
                ...
                F.find("ul:first").children("li").fadeOut(100);
                F.find("ul:first").children("li").eq(E).fadeIn(400);
                F.find(".main_slideshow_nav").children("li").css("background-color",z);
                F.find(".main_slideshow_nav").children("li").eq(E).css("background-color",A);
                E++;
                if(E>=G){
                    E=0
                }
        ...
        function stop(a){
            ...
            if(b != (E-1)){
                ...
                */
                ...
                F.find(".main_slideshow_nav").children("li").css("background-color",z);
                F.find(".main_slideshow_nav").children("li").eq(b).css("background-color",A)
            }
        }

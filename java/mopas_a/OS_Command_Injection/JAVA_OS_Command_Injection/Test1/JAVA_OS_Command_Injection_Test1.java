...
public class CWE78_OS_Command_Injection__connect_tcp_01 extends AbstractTestCase
{
    ...
    public void bad_1() throws Throwable
    {
        String data;
        ...
        Process p = run.exec(osCommand + data);
        p.waitFor();
    ...
    public void bad2() throws Throwable
    {
        ...
        /* POTENTIAL FLAW: command injection */
        ProcessBuilder b = new ProcessBuilder(osCommand + data);
       	Process p;
    ...
    public void bad2_1() throws Throwable
    {
        String data;
        ...
        /* POTENTIAL FLAW: command injection */
        Process process = new ProcessBuilder(osCommand + data).start();
